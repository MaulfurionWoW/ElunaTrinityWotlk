# TrinityCore 3.3.5 + Eluna Lua Engine + Trinity Bots - Build Status
Travis-CI | AppVeyor
:------------: | :------------:
...
**The sources**
- The WoW core : [TrinityCore 3.3.5](#-trinitycore-335)
- The LUA Engine : [Eluna](#-_)
- The Bots (manual) : [NPCBots](#-the-npcbots-manual-)

---------------------------------------
# [![TrinityCore](https://community.trinitycore.org/public/style_images/1_trinitycore.png)](https://github.com/TrinityCore/TrinityCore/tree/3.3.5) TrinityCore (3.3.5)
...
---------------------------------------
# [![Eluna](https://raw.githubusercontent.com/ElunaLuaEngine/Eluna/master/docs/Eluna.png)](https://github.com/ElunaLuaEngine/Eluna) _
...
---------------------------------------
### Contents
1. [Introduction](#npcbot-mod-introduction)
2. [NPCBots](#npcbots)
